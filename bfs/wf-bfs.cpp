    ...
    void push_back(int x) {
        if(size == capacity) {
            ...
            if(prevPointersSize == prevPointersCapacity) {
                prevPointersCapacity *= 2;
                int** new_prevPointers = new int*[prevPointersCapacity];
                std::copy(prevPointers, prevPointers+prevPointersSize, new_prevPointers);
                delete[] prevPointers;
